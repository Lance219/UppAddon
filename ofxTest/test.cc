...
<NAME>PAYMENT RECEIVED - THANK YOU
	...
	EXPECT_TRUE(r("DTPOSTED").Get<String>()=="20241101000000.000[-5:EDT]");
	EXPECT_TRUE(r("TRNAMT").Get<String>()=="26.48");
...
</BANKTRANLIST><LEDGERBAL><BALAMT>3837.24<DTASOF>20241012065958</LEDGERBAL>
